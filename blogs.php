	...
	<div class="container-fluid mt-2">
		<div class="row">
			...
			<div class="col-md-3 col-sm-6">
					...
					<div  class="mt-3">
					<button type="button" class="btn btn-outline-primary">Cricket</button>
					<button type="button" class="btn btn-outline-secondary">Football</button>
					<button type="button" class="btn btn-outline-success">Travel</button>
					</div>
					<div  class="mt-3">
					<button type="button" class="btn btn-outline-primary">Programming</button>
					<button type="button" class="btn btn-outline-secondary">International</button>
					<button type="button" class="btn btn-outline-success">Politics</button>
					</div>
			</div>
		</div>
